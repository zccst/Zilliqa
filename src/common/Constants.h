...
const std::string DS_KICKOUT_MSG = "Epoch_role_func: KICKED OUT FROM DS";
const std::string DS_LEADER_MSG = "Epoch_role_func: DS LEADER NOW";
const std::string DS_BACKUP_MSG = "Epoch_role_func: DS BACKUP NOW";
